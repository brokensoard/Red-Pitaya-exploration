...
#
# edt_red_pitaya.tcl: Tcl script for re-creating project 'edt_red_pitaya'
#
# Generated by Vivado on Mon Sep 11 07:19:52 PDT 2023
...
#
# 1. This project restoration tcl script (edt_red_pitaya.tcl) that was generated.
#
...
set _xil_proj_name_ "edt_red_pitaya"
...
set script_file "edt_red_pitaya.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../../fpga/red-pitaya-exploration/edt/edt_red_pitaya"]"
...
# Create project
create_project ${_xil_proj_name_} ./${_xil_proj_name_} -part xa7z020clg400-1I
...
set_property -name "part" -value "xa7z020clg400-1I" -objects $obj
...
set_property -name "target_part" -value "xa7z020clg400-1I" -objects $obj
...
if { [get_property IS_LOCKED [ get_files -norecurse system.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../../fpga/red-pitaya-exploration/edt/edt_red_pitaya/edt_red_pitaya.gen/sources_1/bd/system/hdl/system_wrapper.v" ]
} else {
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xa7z020clg400-1I -flow {Vivado Synthesis 2023} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/edt_red_pitaya.srcs/utils_1/imports/synth_1" -objects $obj
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xa7z020clg400-1I -flow {Vivado Implementation 2023} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
...
set_property -name "auto_rqs.directory" -value "$proj_dir/edt_red_pitaya.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/edt_red_pitaya.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
